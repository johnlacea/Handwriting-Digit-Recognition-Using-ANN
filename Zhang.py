"""
    ...
    Description : Digit Classification on the MNIST dataset
                  ...
                  It uses numpy, pandas, matplotlib and imageio libraries.
                  ...
                  +++ Testing Performance on 10,000 handwriting records
                  Score is 8907/10000
                  Performance is 89.07%
...
#Gradient Descent is an optimization method that finds the best set of weights and biases
#that minimizes the loss and increases the accuracy of prediction.
